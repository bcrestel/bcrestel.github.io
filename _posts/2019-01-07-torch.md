...
For most operations, tensors can be manipulated very much a numpy array. But
...
### no_grad
You sometimes see code where the wrap some code, often layers value updates,
...
are only active during the training phase.
